  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 transition-all duration-300 ease-out hover:scale-105 hover:text-yellow-300 cursor-pointer">
            {t('hero.welcome')} <span className="text-yellow-300">{t('hero.app_name')}</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-orange-100">
            {t('hero.subtitle')}
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-full px-4 py-2">
              <Clock className="w-5 h-5" />
              <span>{t('hero.feature_realtime')}</span>
            </div>
            <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-full px-4 py-2">
              <Star className="w-5 h-5" />
              <span>{t('hero.feature_instant')}</span>
            </div>
            <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-full px-4 py-2">
              <MapPin className="w-5 h-5" />
        ...
        <div className="mt-16 flex justify-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl">
            <div className="bg-white bg-opacity-15 backdrop-blur-sm rounded-xl p-6 text-center">
              <div className="text-3xl font-bold text-yellow-300">{t('hero.stats_bookings_count')}</div>
              <div className="text-sm text-orange-100">{t('hero.stats_bookings_label')}</div>
            </div>
            <div className="bg-white bg-opacity-15 backdrop-blur-sm rounded-xl p-6 text-center">
              <div className="text-3xl font-bold text-yellow-300">{t('hero.stats_devotees_count')}</div>
              <div className="text-sm text-orange-100">{t('hero.stats_devotees_label')}</div>
            </div>
            <div className="bg-white bg-opacity-15 backdrop-blur-sm rounded-xl p-6 text-center">
              <div className="text-3xl font-bold text-yellow-300">{t('hero.stats_support_count')}</div>
              <div className="text-sm text-orange-100">{t('hero.stats_support_label')}</div>
            </div>
          </div>
        </div>
      </div>
